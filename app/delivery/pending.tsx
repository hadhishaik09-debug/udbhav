...
const steps = [
  { label: "Application Submitted", done: true, icon: "checkmark-circle" },
  { label: "ID Verification", done: true, icon: "id-card" },
  { label: "Background Check", done: false, icon: "shield-checkmark" },
  { label: "Account Activated", done: false, icon: "bicycle" },
];
    ...
    <View style={[styles.container, { paddingTop: insets.top + (Platform.OS === "web" ? 67 : 0), paddingBottom: insets.bottom + (Platform.OS === "web" ? 34 : 0) }]}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.illustrationContainer}>
          <LinearGradient colors={["#FEF3C7", "#FDE68A"]} style={styles.illustration}>
        ...
        <Text style={styles.subtitle}>
          Your delivery partner application has been received. We are verifying your identity and details.
        </Text>
        ...
        <View style={styles.statusCard}>
          ...
          <Text style={styles.statusNote}>Typically takes 12-24 hours</Text>
        </View>
        ...
        <TouchableOpacity onPress={() => router.replace("/delivery/dashboard")} style={styles.skipBtn}>
...
const styles = StyleSheet.create({
  ...
  content: { padding: 24, alignItems: "center", gap: 20, paddingBottom: 40, paddingTop: 20 },
  illustrationContainer: { marginTop: 20, marginBottom: 8 },
  illustration: {
    width: 130,
    height: 130,
    borderRadius: 40,
  ...
  subtitle: { fontSize: 15, fontFamily: "Inter_400Regular", color: Colors.textSecondary, textAlign: "center", lineHeight: 23, paddingHorizontal: 10 },
  statusCard: {
