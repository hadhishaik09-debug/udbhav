      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <View style={styles.card}>
          ...
          <TouchableOpacity
            ...
            disabled={loading}
          >
            <LinearGradient colors={["#F59E0B", "#D97706"]} style={styles.loginBtnGradient}>
        ...
        >
          <View style={styles.registerCard}>
            <Ionicons name="bicycle-outline" size={22} color={Colors.amber} />
            <View>
              <Text style={styles.registerTitle}>New Delivery Partner?</Text>
              <Text style={styles.registerSubtitle}>Register and join our delivery network</Text>
            </View>
